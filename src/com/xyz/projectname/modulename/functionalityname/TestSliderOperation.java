...
// CTRL+Shit+O
public class TestSliderOperation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		//act.dragAndDrop(source, target).perform(); // Default set by Developer
		
		act.dragAndDropBy(source, 1000, 0).perform();
		Thread.sleep(2000);
		act.dragAndDropBy(source, -200, 0).perform();
		Thread.sleep(2000);
		act.dragAndDropBy(source, -200, 0).perform();
